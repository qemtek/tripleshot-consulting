...
export default function Button({ 
  ...
  const variants = {
    primary: "bg-brand-primary hover:bg-indigo-700 text-white shadow-soft hover:shadow-large focus:ring-brand-primary transform hover:scale-105 hover:-translate-y-0.5 before:absolute before:inset-0 before:bg-gradient-to-r before:from-transparent before:via-white/20 before:to-transparent before:-translate-x-full hover:before:translate-x-full before:transition-transform before:duration-700",
    secondary: "bg-brand-secondary hover:bg-purple-700 text-white shadow-soft hover:shadow-large focus:ring-brand-secondary transform hover:scale-105 hover:-translate-y-0.5 before:absolute before:inset-0 before:bg-gradient-to-r before:from-transparent before:via-white/20 before:to-transparent before:-translate-x-full hover:before:translate-x-full before:transition-transform before:duration-700",
